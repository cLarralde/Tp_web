...
class GameModel
{
    ...
    { //INSERTA UN NUEVO ITEM EN LA BD
        ...
        $mensaje = "Se agrego correctamente un nuevo juego";
        return $mensaje;
    }
    ...
    { //ELIMINA UN ITEM EN LA BASE DE BD
        ...
        $mensaje = "Se eliminó correctamente el juego seleccionado";
        return $mensaje;
    }
    ...
    { //EDITA UN ITEM EN LA BD
        ...
        $mensaje = "Se editó correctamente el juego seleccionado";
        return $mensaje;
    }
}
